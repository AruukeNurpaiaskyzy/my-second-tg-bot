...
# идентификатор (ЦЕЛОЕ ЧИСЛО, ПЕРВИЧНЫЙ КЛЮЧ, АВТОИНКРЕМЕНТ)
...
# номер (ТЕКСТ)
# Telegram бот:
# Используйте библиотеку aiogram для создания бота.
# Бот должен принимать команды и ответы от пользователя, чтобы собрать необходимые данные.
# Логика работы бота:
